	...
	public:
		...
		// materials
		std::string	getMtlLibrary ()		{return m_MtlLib;}
		int			getNumGrp()				{return m_MtlList.size(); }
		std::string getGrpMtl(int face_grp)	{return m_MtlList[face_grp]; }
	...
	protected:
		...
		std::string						m_MtlLib;
		std::vector< std::string >		m_MtlList;
