...
#include "common_defs.h"
	...
	HELPAPI void save_png ( char* fname, unsigned char* img, int w, int h, int ch );
	...
	*/
	...
	HELPAPI unsigned decode(std::vector<unsigned char>& out, unsigned& w, unsigned& h,
					const unsigned char* in, size_t insize,
	...
	*/
	...
	HELPAPI unsigned encode(std::vector<unsigned char>& out,
	...
	NOTE: This overwrites existing files without warning!
	*/
	HELPAPI unsigned encode(const std::string& filename,
					const unsigned char* in, unsigned w, unsigned h,
					LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
	HELPAPI unsigned encode(const std::string& filename,
					const std::vector<unsigned char>& in, unsigned w, unsigned h,
	...
	*/
	HELPAPI unsigned lodepng_decode(unsigned char** out, unsigned* w, unsigned* h,
							LodePNGState* state,
							const unsigned char* in, size_t insize);
	...
	*/
	HELPAPI unsigned lodepng_inspect(unsigned* w, unsigned* h,
							 LodePNGState* state,
							 const unsigned char* in, size_t insize);
	#endif /*LODEPNG_COMPILE_DECODER*/
	...
	*/
	HELPAPI unsigned lodepng_load_file(unsigned char** out, size_t* outsize, const char* filename);
	...
	return value: error code (0 means ok)
	*/
	HELPAPI unsigned lodepng_save_file(const unsigned char* buffer, size_t buffersize, const char* filename);
	#endif /*LODEPNG_COMPILE_DISK*/
